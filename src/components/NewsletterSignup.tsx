      ...
      if (error) {
        if (error.code === "23505") {
          toast.info("You're already subscribed!", {
            description: "We'll keep you updated with the monthly roundup.",
          });
        ...
        toast.success("Welcome aboard!", {
          description: "You'll receive our monthly legal roundup.",
        });
        setIsSubscribed(true);
        setEmail("");
      }
      ...
      <div className="container mx-auto px-4 relative">
        <div className="glass-card p-8 md:p-12 max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-3">
            Get the Monthly Legal Round-up
          </h2>
          ...
          {isSubscribed ? (
            <div className="p-4 rounded-lg bg-accent/20 border border-accent/30">
              <p className="text-accent font-medium">
                ✓ You're on the list! Watch your inbox for our next roundup.
              </p>
            </div>
          ) : (
